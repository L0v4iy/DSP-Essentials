...
namespace Unity.Audio
{
    ...
    public unsafe struct DSPCommandBlock : IHandle<DSPCommandBlock>, IDisposable
    {
        ...
        /// <param name="loopPointIsStart">Whether the provider should loop from the beginning of the clip instead of <see cref="startSampleFrameIndex"/></param>
        /// <typeparam name="TParameters">Enum type of the parameters of the node</typeparam>
        /// <typeparam name="TProviders">Enum type of the sample providers of the node</typeparam>
        /// <typeparam name="TAudioKernel">The kernel type of the node</typeparam>
        ...
        public void SetSampleProvider<TParameters, TProviders, TAudioKernel>(
            ...
            long startSampleFrameIndex = 0, long endSampleFrameIndex = 0, bool loop = false, bool enableSilencePadding = false, bool loopPointIsStart = false)
            where TParameters  : unmanaged, Enum
            where TProviders   : unmanaged, Enum
            where TAudioKernel : struct, IAudioKernel<TParameters, TProviders>
        {
            uint sampleProviderId = 0;
            if (clip != null)
                sampleProviderId = clip.Internal_CreateAudioClipSampleProvider((ulong)startSampleFrameIndex,
                    endSampleFrameIndex, loop, enableSilencePadding
            ...
            where TAudioKernel : struct, IAudioKernel<TParameters, TProviders>
        {
            ...
            InsertSampleProvider<TParameters, TProviders, TAudioKernel>(
                clip.Internal_CreateAudioClipSampleProvider((ulong)startSampleFrameIndex, endSampleFrameIndex, loop, enableSilencePadding
#if UNITY_2021_2_OR_NEWER
                    , loopPointIsStart
#endif
                    ),
        ...
        {
            var index = UnsafeUtility.EnumToInt(provider);
