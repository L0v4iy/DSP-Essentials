...
namespace DSPGraphAudio.Kernel.PlayClip
{
    ...
    internal struct PlayClipNode : IAudioKernel<PlayClipNode.Parameters, PlayClipNode.SampleProviders>
    {
    ...
    [BurstCompile(CompileSynchronously = true)]
    internal struct ClipPlayer : IAudioKernelUpdate<PlayClipNode.Parameters, PlayClipNode.SampleProviders, PlayClipNode>
    {
...
// Bootstrap MonoBehaviour to get the example running.
    public class PlayClip : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            _handlerID = _graph.AddNodeEventHandler<ClipStopped>((node, evt) =>
            {
